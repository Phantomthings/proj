...
async def get_overview(
    ...
    # ============================================================
    # CÂBLES DE RECHARGE COUPÉS (PC08 : Plug no Over Temp CCS)
    # ============================================================
    sql_cables = """
    ...
    if not df_cables.empty:
        ...
        if not df_cables.empty:
            ...
            nb_cables_recent = int(df_cables["is_recent"].sum())
    ...
    nb_total_charges_multi = int(pd.to_numeric(df_multi["tentatives"], errors="coerce").sum()) if not df_multi.empty and "tentatives" in df_multi.columns else 0
    ...
    return templates.TemplateResponse(
        "partials/tab_overview.html",
        {
            ...
            "nb_total_charges_multi": nb_total_charges_multi,
            ...
            "nb_cables_recent": nb_cables_recent,
        }
    )
